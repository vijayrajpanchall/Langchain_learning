...
messages = [
    HumanMessage(
        "What is the conversion fector from USD to INR and based on that can you convert 10 USD to INR?"
    )
]
...
for tool_call in ai_message.tool_calls:
    ...
    if tool_call["name"] == "get_conversion_factor":
        ...
        conversion_rate = json.loads(get_conversion_factor_result.content)[
            "conversion_rate"
        ]
