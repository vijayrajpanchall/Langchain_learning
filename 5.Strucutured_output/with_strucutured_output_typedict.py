...
result = structured_model.invoke(
    """I recently purchased the OnePlus 13R as a gift for my mom ahead of Mother’s Day, and it’s been a delightful experience so far. Right out of the box, the packaging felt premium – classic OnePlus style with the bold red theme and neatly arranged accessories.
